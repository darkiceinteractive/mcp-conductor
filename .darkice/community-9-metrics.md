# Community 9 — Metrics
2 files · 6771 tokens · 0% of project

## Files
- `src/metrics/metrics-collector.ts` — (6622 tokens)
- `src/metrics/index.ts` — (149 tokens)
...
- `test/popular-mcps/token-savings/token-savings.test.ts` (importing 1 files)
